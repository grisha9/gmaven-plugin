...
import ru.rzn.gmyasoedov.gmaven.dom.converters.MavenUrlConverter;
import ru.rzn.gmyasoedov.gmaven.dom.model.MavenDomRepositoryBase;
...
public abstract class MavenRepositoryConverter extends ResolvingConverter<String> {
  ...
  public static class Id extends MavenRepositoryConverter {
    ...
    public LookupElement createLookupElement(String s) {
      return LookupElementBuilder.create(s)
        .withIcon(GMavenIcons.MavenPlugin)
  ...
  private static String getRepositoryId(ConvertContext context) {
    MavenDomRepositoryBase repository = context.getInvocationElement()
            .getParentOfType(MavenDomRepositoryBase.class, false);
    return  (repository != null) ? repository.getId().getStringValue() : null;
  }
