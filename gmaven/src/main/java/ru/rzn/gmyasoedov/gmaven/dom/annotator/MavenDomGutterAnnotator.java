...
public class MavenDomGutterAnnotator implements Annotator {
  ...
  private static void annotateDependencyUsages(@NotNull MavenDomDependency dependency, AnnotationHolder holder) {
    ...
    if (children.size() > 0) {
      ...
      iconBuilder.
        setTargets(children).
        setPopupTitle(GDomBundle.message("navigate.parent.dependency.title")).
        setCellRenderer(MyListCellRenderer::new).
        setTooltipText(GDomBundle.message("overriding.dependency.title")).
  ...
  private static void annotateMavenDomPlugin(@NotNull MavenDomPlugin plugin, @NotNull AnnotationHolder holder) {
    ...
    if (managingPlugin != null) {
      ...
      iconBuilder.
        ...
        setTooltipText(GDomBundle.message("overriden.plugin.title")).
  ...
  private static void annotateMavenDomPluginInManagement(@NotNull MavenDomPlugin plugin, @NotNull AnnotationHolder holder) {
    ...
    if (children.size() > 0) {
      ...
      iconBuilder.
        setTargets(children).
        setPopupTitle(GDomBundle.message("navigate.parent.plugin.title")).
        setCellRenderer(MyListCellRenderer::new).
        setTooltipText(GDomBundle.message("overriding.plugin.title")).
        createGutterIcon(holder, xmlTag);
    }
  }
  ...
  private static void annotateMavenDomParent(@NotNull MavenDomParent mavenDomParent, @NotNull AnnotationHolder holder) {
    MavenDomProjectModel parent = MavenDomProjectProcessorUtils
            .findParent(mavenDomParent, mavenDomParent.getManager().getProject());

    if (parent != null) {
      NavigationGutterIconBuilder.create(GMavenIcons.ParentProject, MavenProjectConverter.INSTANCE).
        setTargets(parent).
        setTooltipText(GDomBundle.message("parent.pom.title")).
  ...
  private static void annotateMavenDomProjectChildren(MavenDomProjectModel model, AnnotationHolder holder) {
    ...
    if (mavenProject != null) {
      ...
      if (children.size() > 0) {
        NavigationGutterIconBuilder.create(GMavenIcons.ChildrenProjects, MavenProjectConverter.INSTANCE).
          setTargets(children).
          setCellRenderer(MyListCellRenderer::new).
          setPopupTitle(GDomBundle.message("navigate.children.poms.title")).
          setTooltipText(GDomBundle.message("children.poms.title")).
