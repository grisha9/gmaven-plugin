...
import ru.rzn.gmyasoedov.gmaven.dom.model.presentation.MavenDomPluginPresentationProvider;
 ...
 * </pre>
 */
@Presentation(typeName = "Plugin", icon = "GMavenIcons.MavenPlugin", provider = MavenDomPluginPresentationProvider.class)
