...
class DevAspectjMavenPlugin : MavenCompilerFullImportPlugin {
    ...
    private fun toCompilerData(
        ...
        return CompilerData(
            ...
            plugin.body.annotationProcessorPaths, args.first, args.second
        )
    }
    ...
    private fun collectAjcCompilerArgs(configurationElement: Element?): Pair<List<String>, List<String>> {
        ...
        addBooleanParam(configurationElement, aspectjArgs, "parameters")
        addBooleanParam(configurationElement, aspectjArgs, "enablePreview")
